...
exports.esComercianteOAdministrador = exports.esAnalistaOAdministrador = exports.esComercianteOAnalista = exports.esAnalista = exports.esComerciante = exports.esAdministrador = void 0;
/**
 ...
 */
const esComercianteOAdministrador = (req, res, next) => {
    if (!req.user) {
        return res.status(401).json({ error: 'No autenticado' });
    }
...
exports.esComercianteOAdministrador = esComercianteOAdministrador;
